...
from core.mixins import acesso_vendas, pedido_e_paraiso
...
LOGO_PATH = os.path.join(settings.BASE_DIR, 'static', 'img', 'mascote_paraiso.png')
...
@acesso_vendas
def pedido_pdf_paraiso(request, pk):
    ...
    doc    = SimpleDocTemplate(
        ...
        title=f"Pedido #{pedido.numero}", author='Paraíso do Acrílico',
    )
    ...
    response['Content-Disposition'] = f'inline; filename="pedido_{pedido.numero}_paraiso.pdf"'
